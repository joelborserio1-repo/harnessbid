...
define('PAGE_file','listings_lost');
define('AUTHORISE',1);
...
<div class="frame">
  <div class="member-page-header">
    ...
    <h2>You have <b><?= $product_count; ?></b> horse<?= $zulu->s($product_count); ?> in your missed list.</h2>
    <?php if($product_count == 0) { ?>
    </div>
    <?php } ?>
    <?php if($product_count > 0) { ?>
    <p>Click on any listings in your missed list to see more about it.</p>
