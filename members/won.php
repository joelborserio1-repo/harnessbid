...
<div class="frame">
    ...
    <h2>You have <b><?= $product_count; ?></b> horse<?= $zulu->s($product_count); ?> in your purchased list.</h2>
    <?php if($product_count == 0) { ?>
    </div>
    <?php } ?>
    <?php if($product_count > 0) { ?>
    <p>Click on any listings in your purchased list to see more about it.</p>
    </div>
    <?php } else { ?>
